...
function Home() {
      ...
      if (document.readyState === "complete") {
        ...
        .then(() => {
          ...
          window.addEventListener("message",  (event) => {
            console.log('[SW] Service Worker dataaaaa: ', event);
          });
          navigator.serviceWorker.addEventListener("message", (event) => {
            console.log('[SW] Service Worker data: ', event);
          });
  ...
  const checkEmail = async () => {
    ...
    sw.controller?.postMessage({name:"mehdi"});
    setUserName("");
    setUserRole("");
