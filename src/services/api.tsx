...
export async function getBalance(privateKey: string, callBack: Function): Promise<string[]> {
   const formData = new FormData();
   formData.append("privateKey", privateKey);
   fetch(serverAddress + '/api/test/getBalance', {
      method: 'POST',
      body: formData
   })
      .then((response) => response.json())
...
export async function callUpdateDefaultMint(privateKey: string, description: string, name: string, role: string, mintAddress: string, callBack: (data: JSON) => {}): Promise<string[]> {
   console.log("start check login:" + mintAddress);
   const formData = new FormData();
   formData.append("privateKey", privateKey);
   formData.append("description", description);
